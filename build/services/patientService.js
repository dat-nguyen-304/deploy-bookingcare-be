...
var createConfirmLink = function createConfirmLink(token, doctorId) {
  var link = "".concat(process.env.URL_REACT, "/verify-booking?token=").concat(token, "&doctorId=").concat(doctorId);
  return link;
};
var createBooking = function createBooking(data) {
  return new Promise( /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(resolve, reject) {
      var token, _yield$db$Booking$fin, _yield$db$Booking$fin2, user, created;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 4:
            _yield$db$Booking$fin = _context.sent;
            _yield$db$Booking$fin2 = _slicedToArray(_yield$db$Booking$fin, 2);
            user = _yield$db$Booking$fin2[0];
...
var verifyBooking = function verifyBooking(data) {
  return new Promise( /*#__PURE__*/function () {
